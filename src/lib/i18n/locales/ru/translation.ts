export default {
  system: {
    ...
    rotate3: 'и спрячьте мобильную клавиатуру',
    level: 'Уровень',
  ...
  friends: {
    ...
    playWithMe:
      ...
      '💰 Лови подарок! +3000 монет для тех, кто зашел впервые\n' +
      '🚀 У тебя есть Telegram Premium? Получи +5000 монет!\n',
  },
  earn: {
  ...
  toast: {
    buyCard: {
      ...
      subtitle: 'Время вести свою империю лягушки к величию 👑',
    },
    feedFrog: {
      title: 'Лягушка счастлива!',
      subtitle: 'Отличная работа! Кормите своего питомца, чтобы он продолжал улыбаться 🍽️',
    }
  },  
};
